...
<section>
	...
	<div class="container">
		<div id="div">
			<div class="btn" onclick="location.href='${contextPath}/myShop/itemList';">
				<span>상품</span>
			</div>
			<div class="btn active" onclick="location.href='${contextPath}/myShop/wishList';">
				<span>찜 목록</span>
			</div>
