        ...
        <div class="container" id="con-1">
            <div id="changeDiv">
                <div id="div">
                    ...
                    <div style="width:50%">
                        <select style="width: 150px; text-align-last: center; float:right; height: 25px; border: 0.3px solid #ccc">
                            <option>전체</option>
                        </select>
                    </div>
                </div>
